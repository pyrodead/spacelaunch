...
describe('should render a <UpcomingLaunches />', () => {
    const defaultProps = {
        upcomingLaunches,
        incrementUpcomingLaunchesConnect: jest.fn(),
        incrementLaunchesOffsetConnect: jest.fn(),
        pager: {
            launchesOffset: 10,
        },
    };
    ...
    it('should render without errors', () => {
        ...
        expect(wrapper.find('.sl-upcoming-container')).toHaveLength(1);
    });
    ...
    it('test load more button', async() => {
        ...
        axios.get.mockImplementation(() => Promise.resolve({ status: 200, data: { test: 'data' } }))
        wrapper = mount(
            <HashRouter>
                <UpcomingLaunchesContent {...defaultProps} />
            </HashRouter>
